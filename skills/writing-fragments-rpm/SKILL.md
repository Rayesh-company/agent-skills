---
name: writing-fragments-rpm
description: "Writing (explore phase): MINE raw fragments from a topic — no structure imposed. Use at the start of a writing project, before any shaping decisions. Do not use for shaping mined fragments into a paragraph-structured article — that is writing-shape-rpm."
