---
name: writing-shape-rpm
description: "Writing (exploit phase): shape already-mined raw material into a STRUCTURED ARTICLE, paragraph by paragraph, with explicit section flow. Use when the user has fragments already and wants them shaped into a publishable piece. Do not use for the initial fragment-mining — that is writing-fragments-rpm. Do not use for beat-by-beat narrative assembly — that is writing-beats-rpm."
